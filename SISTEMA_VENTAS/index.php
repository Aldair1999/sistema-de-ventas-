...
<h1><font color="black"><p  id="titulo">SISTEMA DE VENTAS </p></font></h1>
...
<img src="imagen/11.jpg" border="1"  width="88" height="130">
<td label  for="usuario"> <h3><font color="black"><p>Usuario</h3></label></td></p>
<div class="col-xs-10 col-xs-offset-1">
  <input type="text" name="mail" class="form-control Input" required placeholder="">
 </div>
 </div>
<div class="form-group">
<img src="imagen/1.jpg" border="1"  width="88" height="100">
